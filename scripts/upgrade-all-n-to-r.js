...
async function upgradeAllNToR() {
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('🔄 Upgrading All N Type Users to R (B2C)');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');

  try {
    const client = getDynamoDBClient();
    
    // Step 1: Find all v2 vendor_app users with user_type 'N'
    console.log('📋 Step 1: Finding all v2 vendor_app users with user_type N...');
    let lastKey = null;
    const nUsers = [];
    ...
    console.log(`✅ Found ${nUsers.length} users with user_type 'N' (v2 vendor_app)\n`);
    ...
    for (let i = 0; i < nUsers.length; i++) {
      const user = nUsers[i];
      console.log(`\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
      console.log(`Processing User ${i + 1}/${nUsers.length}`);
      console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
      ...
      try {
        ...
        console.log(`   ✅ Updated user_type: N → R`);
        if (user.del_status === 2) {
        ...
        if (shop) {
          ...
          console.log(`   ✅ Updated shop (ID: ${shop.id}) to B2C with approval_status: rejected`);
