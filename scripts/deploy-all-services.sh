...
SERVICES_CONFIG=(
    ...
    "location:512:30:Real-time location tracking service for pickup vendors"
...
# Create zip from project root with all shared code (same exclusions as monolithic)
...
UNZIPPED_SIZE=$(unzip -l "$SHARED_ZIP_FILE" 2>/dev/null | tail -1 | awk '{print $1}')
