...
// Admin Panel routes moved to monolithic Lambda - see routes/webRoutes.js
...
// NOTE: All admin panel routes have been moved to monolithic Lambda (scrapmate-node-api-dev)
// Admin routes are now handled by routes/webRoutes.js in the monolithic code
// This microservice only handles non-admin web panel routes (vendor, agent, customer, etc.)
...
router.get('/site', SitePanelController.getSite);
router.put('/site', SitePanelController.updateSite);
